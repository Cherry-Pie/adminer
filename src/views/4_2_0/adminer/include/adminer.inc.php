...
class Adminer {
	...
	*/
	function head() {
		?>
<link rel="stylesheet" type="text/css" href="<?php echo asset('packages/yaro/adminer/'. Config::get('adminer::version') .'/externals/jush/jush.css'); ?>">
<?php
		return true;
	}
...
<?php
		if ($missing == "auth") {
			...
			if (support("sql")) {
				?>
<script type="text/javascript" src="<?php echo asset('packages/yaro/adminer/'. Config::get('adminer::version') .'/externals/jush/modules/jush.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('packages/yaro/adminer/'. Config::get('adminer::version') .'/externals/jush/modules/jush-textarea.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('packages/yaro/adminer/'. Config::get('adminer::version') .'/externals/jush/modules/jush-txt.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('packages/yaro/adminer/'. Config::get('adminer::version') .'/externals/jush/modules/jush-'. $jush .'.js'); ?>"></script>
<script type="text/javascript">
<?php
				if ($tables) {
					$links = array();
